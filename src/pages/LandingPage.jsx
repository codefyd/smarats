...
function SectorsSection() {
  const sectors = [
    { icon: '🤲', title: 'الجمعيات الخيرية', desc: 'تنبيهات، إعلانات، ترحيب، أرقام الحملات النشطة.' },
    ...
    { icon: '🛎️', title: 'الفروع والاستقبال', desc: 'شاشات الترحيب، إبراز أحدث المنتجات، خدمات الفرع.' }
  ]
  return (
  ...
  return (
    <footer style={{
      ...
      <p style={{
        ...
        منصة سمارات لإدارة شاشات العرض الذكية.
      </p>
